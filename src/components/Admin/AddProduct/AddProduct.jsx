...
const AddProduct = () => {
  const handleSubmit = () => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        fetch("https://creative-agency-beige.vercel.app/uplod", {
          method: "POST",
  ...
  useEffect(() => {
    fetch("https://creative-agency-beige.vercel.app/uplodImages")
      .then((res) => res.json())
      .then((data) => setProduct(data));
  }, []);
  const deleteProduct = (id)=>{
    fetch(`https://creative-agency-beige.vercel.app/delete/${id}`,{
      method: "DELETE",
    })
    .then(res=> res.json())
    .then(result=>{
